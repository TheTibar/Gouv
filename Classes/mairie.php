...
class Mairie {
    ...
    public function createInseeData($insee_code, $order_number, $process_id, $url, $region, $departement) {
        ...
        try {
            ...
            {
                $sql = "INSERT INTO gouv_mairie_insee (insee_code, order_number, process_id, url, region, departement)
						VALUES ('$insee_code', $order_number, $process_id, '$url', '$region', '$departement')";
    ...
    public function getAllUrlWithoutEmail($current_process) {
        $instance = \ConnectDB::getInstance();
        $conn = $instance->getConnection();
    ...
    public function createMairieDetail($insee_code, $order_number, $currentURL, $name, $mayor, $email, $hab, $long, $lat, $current_process) {
        $instance = \ConnectDB::getInstance();
        $conn = $instance->getConnection();
		...
		$long = mysqli_real_escape_string($conn, $long);		$lat = mysqli_real_escape_string($conn, $lat);		$current_process = mysqli_real_escape_string($conn, $current_process);
				...
				$sql = "INSERT INTO gouv_mairie_detail (insee_code, order_number, city_name, commune_url, maire, email, habitants, longitude, latitude, process_id) 
						VALUES ('$insee_code', $order_number, '$name', '$currentURL', '$mayor', '$email', $hab, $long, $lat, $current_process)";
	...
	public function updateMairieDetail($insee_code, $order_number, $maire, $hab, $current_process) {
        $instance = \ConnectDB::getInstance();
        $conn = $instance->getConnection();
